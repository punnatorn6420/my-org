...
const footerColumns: FooterLinkColumn[] = [
  {
    title: 'About Nok Air',
    links: ['Our Story', 'Newsroom', 'Sustainability', 'Investor Relations', 'Careers'],
  },
  {
    title: 'Support',
    links: ['Help Center', 'Contact Us', 'Refund Request', 'Baggage Info', 'Flight Disruptions'],
  },
  {
    title: 'Legal',
    links: ['Terms of Use', 'Privacy Policy', 'Conditions of Carriage', 'Cookie Policy'],
  },
];
    ...
    <footer className="bg-white text-slate-700">
      <div className="mx-auto grid max-w-[1200px] gap-8 px-4 py-12 md:grid-cols-[1.2fr_1fr_1fr_1fr] md:px-6">
        <div>
          ...
          <div className="mt-4 flex items-center gap-2 text-slate-400">
            <a href="#" aria-label="Facebook" className="rounded-full p-1.5 hover:bg-slate-100 hover:text-slate-700">
              <Facebook className="size-4" />
            </a>
            <a href="#" aria-label="Instagram" className="rounded-full p-1.5 hover:bg-slate-100 hover:text-slate-700">
              <Instagram className="size-4" />
            </a>
            <a href="#" aria-label="Twitter" className="rounded-full p-1.5 hover:bg-slate-100 hover:text-slate-700">
      ...
      <div className="border-t border-slate-200">
        <div className="mx-auto flex max-w-[1200px] flex-col gap-2 px-4 py-4 text-xs text-slate-400 md:flex-row md:items-center md:justify-between md:px-6">
          <p>© 2026 Nok Airlines Public Company Limited. All rights reserved.</p>
