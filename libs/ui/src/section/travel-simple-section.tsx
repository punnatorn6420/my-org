  ...
  return (
    <section className="bg-[#101114] py-16 text-white">
      <div className="mx-auto flex max-w-[780px] flex-col items-center px-4 text-center md:px-6">
        <h2 className="text-4xl font-semibold tracking-tight">Travel Made Simple</h2>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Button variant="outline" className="h-10 border-white/20 bg-white text-black hover:bg-white/90">
            <Apple className="size-4" />
            App Store
          </Button>
          <Button variant="outline" className="h-10 border-white/30 bg-transparent text-white hover:bg-white/10">
