...
export function TravelSimpleSection(
  props: TravelSimpleSectionProps = defaultSectionProps[
    'travel-simple-section'
  ],
) {
  const appButtons = Array.isArray(props?.appButtons)
    ? props.appButtons
    : defaultSectionProps['travel-simple-section'].appButtons;
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          {appButtons.map((button) => (
            <Button
              ...
              variant="outline"
              className={
                button.platform === 'apple'
                  ? 'h-10 border-white/20 bg-white text-black hover:bg-white/90'
