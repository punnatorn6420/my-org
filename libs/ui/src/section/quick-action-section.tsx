...
const iconMap: Record<
  QuickActionSectionProps['items'][number]['icon'],
...
export function QuickActionSection(
  props: QuickActionSectionProps = defaultSectionProps['quick-action-section'],
) {
  const items = Array.isArray(props?.items)
    ? props.items
    : defaultSectionProps['quick-action-section'].items;
